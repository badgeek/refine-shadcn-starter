...
function renderMoreEventsIndicator(dayEvents: any[]) {
  ...
  return (
    <button className="absolute bottom-0 right-2 mb-1  px-2 py-0 text-xs font-medium bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 rounded hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors">
